...
class Walker2DChangingVelEnv(RandomEnv, utils.EzPickle):
    def __init__(self, *args, **kwargs):
        ...
        RandomEnv.__init__(self, kwargs.get('log_scale_limit', 0), 'walker2d.xml', 5, hfield_mode=kwargs.get('hfield_mode', 'gentle'), rand_params=[])
